...
**Current Phase**: Phase 1 pending — scaffold + orchestration complete, no implementation tasks started
...
| 1: Foundation | pending | 0 | 7 | Camera + MediaPipe + rVFC loop |
...
|---|---|---|---|---|---|
| 1.1 | Harden scaffold + CI | pending | | | |
