...
**Current Phase**: DR-7 (primitives) — DR-7.1 Button + DR-7.2 Segmented + DR-7.3 Slider + DR-7.4 Toggle + DR-7.5 ColorPicker + DR-7.6 LayerCard + DR-7.7 useParam done; DR-7.R showcase regression next; Phase 5 paused after 5.2 and resumes as DR-9
...
| DR-7: Component primitives | in-progress | 7 / 8 | 8 | Button / Segmented / Slider / Toggle / ColorPicker / LayerCard / useParam + showcase regression |
